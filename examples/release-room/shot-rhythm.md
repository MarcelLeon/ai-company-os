...
Round 147 发布复核:当前 `docs/assets/release-room-demo.gif` 约 95 秒、`360 x 730`,首帧不是
Telegram 产品画面,也没有把 `/morning` 和 `/view` 作为最新能力前置展示。D0 前如果 README
仍把 GIF 放在首屏,必须按下面节奏复剪。
